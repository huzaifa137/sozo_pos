...
@push('styles')
    <style>
        ...
        .price-block.sell .pvalue {
            color: var(--success);
        }

        .price-block.buy .pvalue {
            color: var(--text);
        }
                ...
                <div class="item-card">
                    ...
                    <div class="item-body">
                        ...
                        <div class="item-actions">
                            ...
                            <form action="{{ route('inventory.destroy', $item) }}" method="POST" class="delete-form">
                                @csrf
                                @method('DELETE')

                                <button type="submit" class="btn-del delete-btn" style="width:100%">
        ...
        <script>
            document.querySelectorAll('.delete-form').forEach(form => {
                form.addEventListener('submit', function (e) {
                    ...
                    let text = form.querySelector('.btn-text');
